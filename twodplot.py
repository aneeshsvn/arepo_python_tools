...
def galaxy2Dplots(path,snapnum,p_type,particle_property,view='xy',box_height=5,box_length=20,box_width=20,Nbins=1000,method='binning',ngb=12,align=False,centre=None,fill=0,gauss=0,save_name='0',dpi=300,figure=None,axis=None,showBH=True,colorbar=True,font_size=10,figuresize=None,scalelen='auto',smooth=True, plotlightpeak=False):
    '''
...
#             if particle_property== 'Velocity' or 'Temperature':
    ...
    if (particle_property=='Velocities'):
...
#         ax0.set_title('Pressure of {}, t={} Gyr'.format(partname[p_type],snapnum*0.005))
